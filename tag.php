...
$this_tag_title = single_tag_title("", FALSE);
$tags = get_tags (array("name__like"=>$this_tag_title));

$subquery = "tag=".$tags[0]->slug."&";
		...
		<div id="content">
            <div id="whitebox_big">
                ...
                <div id="whitebox_big_body">
                    <span id="whitebox_big_body_title"><h1>Blog Archive: <?php single_tag_title() ?></h1></span>
