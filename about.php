...
?>
                        <div id="whitebox_primary_body_content_<?php echo $founder; ?>" class="whitebox_primary_body_content_founder"<?php if ($founder!="gerrie") { echo " style=\"display: none;\""; } ?>>
...
foreach ($founder_posts as $founder=>$founder_post) {
?>
                        <div id="bluebox_body_content_<?php echo $founder; ?>" class="bluebox_body_content_item" style="display: none;">
