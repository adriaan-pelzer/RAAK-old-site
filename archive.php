...
?>
                    <div id="whitebox_primary_body_post_<?php echo $i; ?>" class="whitebox_primary_body_post">
                        ...
                        <div class="whitebox_primary_body_attr">
                            <span id="whitebox_primary_body_attr_author" class="whitebox_primary_body_attr_item">Posted by <a href=""><?php echo the_author_meta ('display_name', $post->post_author); ?></a></span>
                            <span class="seperator">|</span>
                            <span id="whitebox_primary_body_attr_date" class="whitebox_primary_body_attr_item"><?php echo strftime ('%e %B %Y', strtotime ($post->post_date)); ?></span>
                            <span class="seperator">:</span>
...
?>
                        <li><a href="?authorid=<?php echo $author->ID; ?>"><?php echo $display_name; ?></a></li>      
<?php
    }
}
?>
