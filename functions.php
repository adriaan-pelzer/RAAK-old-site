...
function sandbox_globalnav() {
	...
	if ( $menu = str_replace( array( "\r", "\n", "\t" ), '', wp_list_pages('title_li=&sort_column=menu_order&echo=0&depth=1&exclude='.$blogarchive_id) ) ) {
        ...
        foreach (array("About", "Our work", "Contact") as $title) {
            $menu = patch_nofollow ($menu, $title);
        }
		$menu = '<ul><li class="first-page-item"><div class="first_topmenu_top"></div><div class="first_topmenu_body"></div></li>' . $menu . '</ul>';
    }
