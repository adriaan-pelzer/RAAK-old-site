...
<![endif]-->
            ...
            <form action="http://wewillraakyou.us1.list-manage.com/subscribe/post?u=898b1ec2bd8b50ddb10f7dfd0&amp;id=1c536f46e3" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" style="font: normal 100% 'helvetica neue';font-size: 12px;">
	            ...
	            <legend style="font-family: 'helvetica neue', helvetica, arial, sans-serif;color: #FF0087;background: #CCCCCC;padding: .5em 1em;border: 1px solid #000000;-moz-border-radius: 4px;border-radius: 4px;-webkit-border-radius: 4px;font-size: 1.2em;text-align: center;"><span style="color:#ffffff;">** <a href="http://wewillraakyou.com/blog/the-raakonteur/" style="color:#B9E5FB;text-decoration:none;">Read</a> what other's have to say about The RAAKonteur</span></legend>
...
if (($post->post_title == "Gerrie Smits") || ($post->post_title == "Wessel van Rensburg") || ($post->post_title == "Adriaan Pelzer")|| ($post->post_title == "About")) {
    $about = true;
}
?>
...
}).render().setUser('adriaan_pelzer').start();
            </script>
            </div>
            <div id="twitter_bottom"></div>
        </div><!-- twitter -->
...
}).render().setUser('wildebees').start();
            </script>
            </div>
            <div id="twitter_bottom"></div>
        </div><!-- twitter -->
