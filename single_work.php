...
<?php
    ...
    $seperator = TRUE;
?>
                        <span id="whitebox_big_body_nav_<?php echo $slug; ?>" class="whitebox_big_body_nav_item<?php echo $classadd; ?>"><a href="<?php echo get_bloginfo ('url'); ?>/our-work/?category=<?php echo $slug; ?>"><?php echo $project_type; ?></a></span>
<?php
}
?>
...
foreach (array("client"=>"Client", "project"=>"Project", "brief"=>"Brief", "solution"=>"Solution") as $section_slug=>$section_title) {
    if ($seperator) {
?>
                    <hr class="solid">
<?php
